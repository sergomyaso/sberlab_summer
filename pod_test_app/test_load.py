...
if __name__ == '__main__':
    entity = DeployEntity("template/DeployTemplate.yaml", "java-http", "sergomyaso/java-http", "50Mi", 1)
    handler = ResourceHandler("configs/myaso-config.yaml")
    #handler.apply_deployment(entity)
    #handler.remove_deployment(entity)
