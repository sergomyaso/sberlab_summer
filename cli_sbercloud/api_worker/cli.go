...
import (
	...
	"io/ioutil"
	"net/http"
	"nsu.ru/cli_sbercloud/v0/api_worker/core"
)
...
func demoApp() {
	...
	//r, _ := http.NewRequest("GET", "https://vpc.ru-moscow-1.hc.sbercloud.ru/v1/0b5a73ddd98027372f2ec00668b88856/vpcs?limit=1", ioutil.NopCloser(bytes.NewBuffer([]byte(""))))
